...
typedef struct {
...
#else
	int			(*ReadFromSaveGame_)(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr /*= NULL*/);
	int			ReadFromSaveGame(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr = NULL) {
		return ReadFromSaveGame_(chid, pvAddress, iLength, ppvAddressPtr);
	}
	int			(*ReadFromSaveGameOptional)(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr /*= NULL*/);
#endif
...
#else
	void	(*trace_)( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, 
	...
	void	trace(trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, 
			const int passEntityNum, const int contentmask , const EG2_Collision eG2TraceType = G2_NOCOLLIDE, const int useLod = 0) {
		trace_(results, start, mins, maxs, end, passEntityNum, contentmask, eG2TraceType, useLod);
	}
#endif
...
int			(*G2API_InitGhoul2Model_)(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin /*= NULL*/,
								  qhandle_t customShader /*= NULL*/, int modelFlags /*= 0*/, int lodBias /*= 0*/);
int			G2API_InitGhoul2Model(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin = NULL,
								  qhandle_t customShader = NULL, int modelFlags = 0, int lodBias = 0) {
...
qboolean	G2API_SetBoneAnglesIndex(CGhoul2Info *ghlInfo, const int index, const vec3_t angles, const int flags,
							 const Eorientations yaw, const Eorientations pitch, const Eorientations roll,
							 qhandle_t *modelList, int blendTime = 0, int currentTime = 0) {
	return G2API_SetBoneAnglesIndex_(ghlInfo, index, angles, flags, yaw, pitch, roll, modelList, blendTime, currentTime);
}
qboolean	(*G2API_SetBoneAnglesMatrix)(CGhoul2Info *ghlInfo, const char *boneName, const mdxaBone_t &matrix, const int flags,
									  qhandle_t *modelList, int blendTime /*= 0*/, int currentTime /*= 0*/);
void			(*G2API_CopyGhoul2Instance_)(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex /*= -1*/);
inline void		G2API_CopyGhoul2Instance(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex = -1) {
	G2API_CopyGhoul2Instance_(ghoul2From, ghoul2To, modelIndex);
}
qboolean	(*G2API_SetBoneAnimIndex_)(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame /*= -1*/, const int blendTime /*= -1*/);
qboolean	G2API_SetBoneAnimIndex(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame = -1, const int blendTime = -1) {
	return G2API_SetBoneAnimIndex_(ghlInfo, index, startFrame, endFrame, flags, animSpeed, currentTime, setFrame, blendTime);
}
#endif
